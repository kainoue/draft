...
例えば，「KāTiBun\footnote{大文字のアルファベットは語根を示す。}」は「作家」を意味し，「KiTāBun」は「本」を意味する．
...
表1の例であれば，「KāTiBun」と「KiTāBun」はともに辞書の見出し語「KTB」のグループにまとめられている．
...
\begin{tabular}{l|cc}
   語根& NWM & 寝ること\\
  \hline
 派生語& NāMa & 寝る\footnote{三人称男性単数完了形}\\
  派生語& NiYāMun & 睡眠\\
\hline
\end{tabular}
...
「NWM」は「寝る」に関わる語根だが，これが派生した動詞「NāMa」では第二子音「W」が長母音化し，名詞「NiyāMun」では同じく第二子音「W」が「Y」に変化している．
...
表4の例であれば，「KuTTāBun」は「KāTiBun」に，「KuTuBun」は「KiTāBun」に戻さなければ辞書を引くことはできない．
...
図２のように，基本形検索においてكと入力すると，語彙データにあるكから始める語が検索候補として表示される．
